...
``` {r extraction-donnees-lineaires, ehco=FALSE, fig.width=7, fig.eight=5, fig.align="center"}
library(ggplot2)
library(dplyr)
library(tidyr)
# Charger les bibliothèques nécessaires
...
``` {r graphique-ggplot-lineaire, ehco=FALSE, fig.width=7, fig.eight=5, fig.align="center"}
library(ggplot2)
library(dplyr)
library(tidyr)
df_long <- df_cln %>%
...
``` {r graphique-ggplot-boxplot, ehco=FALSE, fig.width=7, fig.eight=5, fig.align="center"}
library(ggplot2)
ggplot(df_long, aes(x = Année, y = Taux_participation, group = "Province/territoire", color = "Province/territoire")) +
  geom_line() +
  geom_point() +
...
``` {r graphique-ggplot-coefcan, ehco=FALSE, fig.width=7, fig.eight=5, fig.align="center"}
library(ggplot2)
library(readr)
ED_Canada_2021_prov_tx_part <- read_csv("C:\\Users\\willi\\OneDrive\\Documents\\WilliamBeaudry.github.io\\projet_session\\ED-Canada_2021_prov_tx_part.csv")
...
``` {r graphique-ggplot-coefprov, ehco=FALSE, fig.width=7, fig.eight=5, fig.align="center"}
ggplot(df, aes(x = prop_indigenous, y = TAUX_PARTICIPATION, color = PROV)) +
  geom_point(size = 1, alpha = 0.7) + 
