...
Pour ce qui est de la participation aux élections de 2021, la corrélation entre la proportion d'électeurs autochtones dans une circonscription et la participation électorale n'est pas plus négative au Québec que dans d'autres provinces. Le coefficient de corrélation est de -0,235 au Québec tandis qu'ils est plus négatif en Ontario (-0,296), en Nouvelle-Écosse (-,370), au Manitoba (-0,433) et en Saskatchewan (-0,645).
